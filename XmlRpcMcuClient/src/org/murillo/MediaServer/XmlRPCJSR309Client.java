...
public class XmlRPCJSR309Client {
    ...
    public boolean EndpointAttachToAudioTranscoder(int sessId,int endpointId,int transcodeId) throws XmlRpcException
    {
        //Create request
   ...
   public boolean VideoMixerPortAttachToEndpoint(int sessId,int mixerId,int portId,int endpointId) throws XmlRpcException
    ...
    public Integer AudioTranscoderCreate(int sessId,String tag) throws XmlRpcException
    {
        //Create request
        Object[] request = new Object[]{sessId,tag};
        //Execute
    ...
    public boolean AudioTranscoderDelete(int sessId,int transcoderId) throws XmlRpcException
    {
        //Create request
    ...
    public boolean AudioTranscoderSetCodec(int sessId,int transcoderId,Integer codec, HashMap<String,String> params) throws XmlRpcException
    {
        //Create request
    ...
    public boolean AudioTranscoderAttachToEndpoint(int sessId,int transcoderId,int endpointId) throws XmlRpcException
    {
        //Create request
    ...
    public boolean AudioTranscoderDetach(int sessId,int transcoderId) throws XmlRpcException
    {
        //Create request
        Object[] request = new Object[]{sessId,transcoderId};
        //Execute
    ...
    public boolean VideoTranscoderSetCodec(int sessId,int videoTranscoderId,Integer codec,int size,int fps,int bitrate,int intraPeriod, HashMap<String,String> params) throws XmlRpcException
    {
        //Create request
    ...
    public boolean VideoTranscoderDettach(int sessId,int videoTranscoderId) throws XmlRpcException
    {
       ...
       public boolean ConfigureMediaConnection(int sessId,int EndpointId,Codecs.MediaType media, Codecs.MediaRole role, Codecs.MediaProtocol protocol, String token, String expectedPayload) throws XmlRpcException
    {
        //Create request
