...
public class MediaDescription {
    ...
    public void addAttribute(Attribute attr) {
     ...
     public void addAttribute(Attribute attr,Integer index) {
          if (! attributes.contains(attr))
    ...
    public List<String> getRtcpFb()
    {
        ArrayList<String> fbmsg = new ArrayList<String>();
        for (Attribute attr : attributes )
        {
            if (attr.getField().equals("rtcp-fb"))
            {
    ...
    public Attribute getRtpMapAttribute(String value) {
        //For each attribute
        for (Attribute attr : attributes )
            //Check if the one searhced
            if ( attr.getValue() != null && attr.getValue().equalsIgnoreCase(value))
                //Found
                return attr;
        //Not found
        return null;
    ...
    public void addAttribute(String field, String value,Integer index) {
        attributes.add(index,new BaseAttribute(field,value) );
    }
    ...
    public void addRTPMapAttribute(RTPMapAttribute rtpMapAttr) {
        addAttribute( rtpMapAttr);
    }
