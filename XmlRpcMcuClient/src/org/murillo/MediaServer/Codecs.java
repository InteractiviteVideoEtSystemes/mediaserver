...
public class Codecs {
   ...
   public static enum MediaType {
    ...
    public static enum MediaRole {
        VIDEO_MAIN("main",0),
        MEDIA_MAIN("main",0),
        VIDEO_SLIDES("slides",1);

        public final String name;
        public final Integer value;

        MediaRole(String name,Integer value){
            this.name = name;
            this.value = value;
        }
    ...
    public static enum MediaProtocol {
        RTP("RTP",0),
        RTMP("RTMP",1),
        WS("WS",2),
        TCP("TCP",3),
        ...
        MediaProtocol(String name,Integer value){
            this.name = name;
            this.value = value;
        }
    ...
    public static Integer getCodecForName(String media,String name)
    {
        ...
        else if (media.equals("application"))
        {
            if (name.equalsIgnoreCase("BFCP"))         return BFCP;
        }
        return -1;
    }
